...
CAMLP4OPTIONS:=
TIMING_PLUGIN=src/timing_plugin.cma
TIMING_PLUGINOPT=src/timing_plugin.cmxs
...
src/timing_plugin.cmxs: src/timing_plugin.cmx
	$(CAMLOPTLINK) $(ZDEBUG) $(ZFLAGS) -shared -o src/timing_plugin.cmxs src/timing_plugin.cmx

src/timing_plugin.cma: src/timing_plugin.cmo src/timing_plugin.cmo
	$(CAMLLINK) -g -a -o src/timing_plugin.cma src/timing_plugin.cmo src/timing_plugin.cmo

%.vo %.glob: %.v $(TIMING_PLUGINOPT) $(TIMING_PLUGIN)
...
clean:
	...
	- rm -rf html
	- rm -f src/timing_plugin.cmxs
	- rm -f src/timing_plugin.cma
...
Makefile: arguments.txt
	mv -f Makefile Makefile.bak
	$(COQBIN)coq_makefile -f arguments.txt -o Makefile
